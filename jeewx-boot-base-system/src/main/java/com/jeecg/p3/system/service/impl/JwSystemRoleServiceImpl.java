...
public class JwSystemRoleServiceImpl implements JwSystemRoleService {
	...
	public PageList<JwSystemRole> queryPageList(PageQuery<JwSystemRole> pageQuery) {
		...
		PageQueryWrapper<JwSystemRole> wrapper = new PageQueryWrapper<JwSystemRole>(pageQuery.getPageNo(),
	...
	@Override
	public JwSystemRole getByRoleId(String roleId) {
		return jwSystemRoleDao.getByRoleId(roleId);
	}
